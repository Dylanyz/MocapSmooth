...
# Canonical source: Tools/smooth_core.py at the MocapSmooth repo root
# sha256[:16] = 9170abdcfd935ef9   copied 2026-09-15
# If the canonical copy changes, re-copy this file rather than patching it.
"""
...
See ../references/rokoko-measurement.md.
